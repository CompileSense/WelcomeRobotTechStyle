...
/**
 * Created by shenjingyuan002 on 2017/1/13.
 */
...
public class FaceView extends ImageView {
    ...
    private Paint mPaint = new Paint(),mDecoPaint = new Paint(),mDecoPaint2 = new Paint();
    private Rect rectSrc = new Rect(),rectDst = new Rect();
    private ValueAnimator mAnimator;
    BitmapShader faceShader,decorateShader,decorateShader2;
    ...
    void handOffSetValue(float value){
